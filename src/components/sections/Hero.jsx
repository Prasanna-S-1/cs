...
const Hero = () => {
  ...
  return (
    ...
    // FIX APPLIED: Added -mt-24 and adjusted pt to pull the section up and cover the white space
    <section
      ref={sectionRef}
      aria-label="Combo Square Hero Section"
      className="relative bg-[#0f0518] overflow-hidden min-h-screen flex items-center pt-40 pb-20 lg:pt-32 lg:pb-0 w-full -mt-24"
    >
